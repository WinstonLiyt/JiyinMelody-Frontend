<template>
    <div style="height: 100vh; overflow: hidden; display: flex; align-items: center; justify-content: center; background-color:burlywood">
        ...
        <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
          <el-form :model="user" style="width: 80%" :rules="rules" ref="registerref">
            ...
            <div style="display:flex">
              <div style="flex: 1">已有账号?去<span style="color:lightseagreen; cursor: pointer; text-decoration: underline;" @click="$router.push('/login')">登录</span></div>
            </div>
