      ...
      <div class="center2">
        <div class="left" style="margin: 20px;">
          ...
          <div style="margin-top: 40px; margin: 20px;">
            <el-button type="primary" round style="width: 100%; background-color:#5f9592; font-size: 20px" @click="$router.push({ name: 'EditView', params: { id: user.id } })">
          ...
          <div style="margin: 20px;">
            ...
            <el-button type="primary" round style="width: 100%; background-color:#5f9592; font-size: 20px" @click="triggerFileInput">
...
.bordered-div {
    border: 5px solid rgb(18, 154, 199); /* 绿色边框 */
    border-radius: 20px;
    padding: 10px; /* 内边距 */
