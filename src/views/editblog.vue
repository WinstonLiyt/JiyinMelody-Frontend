<template>
  ...
  <div class="main-content">
      <div style="width: 50%; margin: 5px auto; align-items: center; justify-content: center;">
        <div class="card" style="margin-bottom: 100px;  flex-wrap: wrap;">
          ...
          <div style="font-weight: bold; font-size: 24px; margin-bottom: 30px;">编辑博客</div>
          </div>
  
         
          <el-form :model="blog" label-width="100px" align="left" style="padding-right: 50px; text-align: left" :rules="rules" ref="blogref">
          ...
          <div style="text-align: center"><el-button type="primary" size="medium" style="width: 100px" @click="editblog">发布</el-button></div>
        </div>
      </div>
      </div>
  ...
  import {gettags,gettheblog, update_blog} from '@/api/blogs.js'
      ...
      getblog(){
        ...
        gettheblog({
            ...
            if(response.data.code == 200) {
                ...
                this.blog.music_file_id = response.data.data.music_file_id;
                this.blog.video_file_id = response.data.data.vidoe_file_id;
                this.blog.tags = response.data.data.tags;
                this.blog.is_only_for_musician = response.data.data.is_only_for_musician;
                this.music_url = response.data.data.music_url;
                this.object.url = response.data.data.music_url;
            } else {
