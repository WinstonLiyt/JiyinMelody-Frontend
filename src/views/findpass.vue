<template>
  <div
    style="height: 100vh; overflow: hidden; display: flex; align-items: center; justify-content: center; background-color:slategray">
      ...
      <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
        <el-form :model="user" style="width: 80%" :rules="rules" ref="findpassref">
          ...
          <el-form-item prop="password">
            <el-input prefix-icon="el-icon-lock" size="large" show-password placeholder="请输入新密码" v-model="user.password"
              clearable></el-input>
          </el-form-item>
          ...
          <div style="display:flex">
            <div style="flex: 1">放弃修改?去<span style="color:lightseagreen; cursor: pointer; text-decoration: underline;"
