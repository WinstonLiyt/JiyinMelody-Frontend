        ...
        <el-container>
            ...
            <el-main>
                ...
                <div v-if="OnePage" style="margin-top: 20px;">
                    ...
                    <div style="margin-bottom: 20px;">
                        <el-button type="primary" @click = "NoticeEditFlag = true">创建新通知<i class="el-icon-circle-plus-outline"></i></el-button>
                    </div>
                ...
                <!-- <div v-if="TwoPage">
                    ...
                    <el-table :data="tableData" stripe header-cell-class-name="headerb-g-c">
                        ...
                        <el-button type="success">通过<i class="el-icon-edit"></i></el-button>
                        <el-button type="danger">驳回<i class="el-icon-remove-outline"></i></el-button>
                        </el-table-column>
                    </el-table>
                ...
                <div v-if="TwoPage" style="margin-top: 50px;">
                    ...
                    <el-table :data="visible_ApplicationData" stripe header-cell-class-name="headerb-g-c"
                        ...
                        <el-table-column prop="video_url" label="视频">
                            <template slot-scope="scope">
                                <a @click="playVideo(scope.row.video_url)" style="cursor: pointer; color: blue;">播放视频</a>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="操作">
                            <template slot-scope="scope">
                                <el-button type="success" @click="approve_application(scope.row)">通过<i class="el-icon-edit"></i></el-button>
                                <el-button type="danger" @click="reject_application(scope.row)">驳回<i class="el-icon-remove-outline"></i></el-button>
                            </template>
                        </el-table-column>
                    ...
                    <div style="padding: 10px 0;">
                        <el-pagination
                            :page-sizes="[5, 10, 15, 20]"
                            :page-size="pageSize_Application"
                            layout="total, sizes, prev, pager, next, jumper"
                            :total="table_ApplicationData.length"
            ...
            <el-dialog
                ...
                <span slot="footer" class="dialog-footer">
                    <el-button type="primary" @click="Click_createNotice_True"
                        >确 定</el-button
                    >
...
export default {
    ...
    methods:{
        ...
        // openAdminList() {
        // this.$alert('对不起，你并不是超级管理员，不能查看管理员申请', '提示', {
        ...
        //     if(this.current_user.is_superuser === false)
        //     {
        //         this.openAdminList();
        //     }
        //     else{
        ...
        //     searchUser(
        //         {
        //             user_id: this.help_search_user.id
        //         }
        //     ).then(response => {
        //         console.log(response.data);
        //         if (response.data.code === 200) {
        //             this.user_search = response.data.data;
        //             console.log("boke")
