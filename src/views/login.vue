<template>
    <div style="height: 100vh; overflow: hidden; display: flex; align-items: center; justify-content: center; background-color:darkcyan">
        ...
        <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
          <el-form :model="user" style="width: 80%" :rules="rules" ref="loginref">
            ...
            <div style="display:flex">
              <div style="flex: 1">还没有账号?去<span style="color:darkcyan; cursor: pointer; text-decoration: underline;" @click="$router.push('/register')">注册</span></div>
              <div style="flex: 1;text-align: right;"><span style="color:darkcyan; cursor: pointer; text-decoration: underline;" @click="$router.push('/findpass')">忘记密码?</span></div>
            </div>
